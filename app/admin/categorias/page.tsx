      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: 20 }}>
          <button onClick={() => { setForm(EMPTY_CAT); setShowForm(true) }}
            style={{ background: GOLD, border: 'none', borderRadius: 10, padding: '10px 20px', color: '#1E2B80', fontWeight: 900, fontSize: 14, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: 16 }}>
            <div style={{ background: '#0a1628', border: '1px solid rgba(212,175,55,0.3)', borderRadius: 20, padding: 28, width: '100%', maxWidth: 480, maxHeight: '90vh', overflowY: 'auto' }}>
              ...
              <div style={{ display: 'flex', gap: 10, marginTop: 24 }}>
                ...
                <button onClick={handleSave} disabled={saving} style={{ flex: 2, background: GOLD, border: 'none', borderRadius: 10, padding: 12, color: '#1E2B80', fontWeight: 900, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, opacity: saving ? 0.7 : 1 }}>
          ...
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: 16 }}>
            <div style={{ background: '#0a1628', border: '1px solid rgba(212,175,55,0.3)', borderRadius: 20, padding: 28, width: '100%', maxWidth: 400 }}>
              ...
              <div style={{ display: 'flex', gap: 10, marginTop: 24 }}>
                ...
                <button onClick={handleSaveSub} disabled={savingSub} style={{ flex: 2, background: GOLD, border: 'none', borderRadius: 10, padding: 12, color: '#1E2B80', fontWeight: 900, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, opacity: savingSub ? 0.7 : 1 }}>
                  ...
                  <div style={{ borderTop: '1px solid rgba(212,175,55,0.1)', background: 'rgba(0,0,0,0.2)', padding: '12px 16px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                      ...
                      <button
                        ...
                        style={{ background: GOLD, border: 'none', borderRadius: 8, padding: '6px 12px', color: '#1E2B80', fontWeight: 900, fontSize: 12, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4 }}>
