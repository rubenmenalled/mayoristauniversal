        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10, marginBottom: 20, flexWrap: 'wrap' }}>
          ...
          <button
            ...
            style={{
              ...
              padding: '10px 20px', color: '#1E2B80', fontWeight: 900, fontSize: 14,
              cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8,
            }}>
        ...
        {showImport && (
          <div style={{
            ...
            <div style={{
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                    {Object.keys(importPreview[0]).map(col => (
                      <span key={col} style={{
                        ...
                        borderRadius: 6, padding: '3px 8px', fontSize: 11, color: '#D4AF37', fontWeight: 700,
                      }}>{col}</span>
                    ))}
                  </div>
                </div>
              ...
              <div style={{ marginBottom: 20, background: 'rgba(212,175,55,0.08)', border: '1px solid rgba(212,175,55,0.3)', borderRadius: 12, padding: '14px 16px' }}>
                <div style={{ color: '#D4AF37', fontSize: 12, fontWeight: 700, marginBottom: 8 }}>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                <button onClick={handleImport} disabled={importing}
                  style={{
                    ...
                    color: '#1E2B80', fontWeight: 900, cursor: 'pointer',
              ...
              <div style={{ display: 'grid', gap: 14 }}>
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{ width: '100%', background: '#0a1628', border: '1px solid rgba(212,175,55,0.25)', borderRadius: 8, padding: '10px 12px', color: form.categoria ? '#fff' : '#7a8a9a', fontSize: 14, outline: 'none' }}>
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{ width: '100%', background: '#0a1628', border: '1px solid rgba(212,175,55,0.25)', borderRadius: 8, padding: '10px 12px', color: '#FFFFFF', fontSize: 14, outline: 'none' }}>
