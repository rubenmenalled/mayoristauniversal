    ...
    <div style={{ minHeight: '100vh', background: `linear-gradient(135deg,${NAVY} 0%,${NAVY2} 100%)` }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div>
            <div style={{ color: '#fff', fontWeight: 900, fontSize: 15 }}>Clientes registrados</div>
              ...
              <table style={{
                ...
                <tbody>
                  {filtered.map((c, i) => (
                    ...
                    >
                      <td style={{ padding: '12px 16px', fontWeight: 700, color: '#fff' }}>{c.nombre}</td>
            ...
            {filtered.map(c => (
              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 12 }}>
                  <div>
                    <div style={{ color: '#fff', fontWeight: 800, fontSize: 15 }}>{c.nombre}</div>
