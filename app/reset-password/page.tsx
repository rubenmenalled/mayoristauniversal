  ...
  if (checking) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(180deg,#FFFFFF,#F0F0F0)' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ color: '#FF6A3D', fontWeight: 700, fontSize: 15 }}>Verificando link...</div>
      </div>
    </div>
  )
  ...
  if (!ready) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(180deg,#FFFFFF,#F0F0F0)', padding: 24 }}>
      <div style={{ textAlign: 'center', maxWidth: 400 }}>
        ...
        <a href="/login" style={{ background: 'linear-gradient(135deg,#FF6A3D,#FF8A63)', color: '#fff', fontWeight: 900, padding: '12px 28px', borderRadius: 10, textDecoration: 'none', fontSize: 14 }}>
          Ir al login
        </a>
      </div>
    </div>
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 440 }}>
        ...
        <p style={{ textAlign: 'center', marginTop: 20, color: '#4b5563', fontSize: 13 }}>
          <a href="/login" style={{ color: '#FF6A3D', textDecoration: 'none' }}>← Volver al login</a>
        </p>
      </div>
    </div>
  )
