  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(180deg,#1E2B80,#1A1E5E)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 16, padding: 24 }}>
      ...
      <div style={{ display: 'flex', gap: 12, marginTop: 8, flexWrap: 'wrap', justifyContent: 'center' }}>
        <button onClick={() => router.push('/checkout')} style={{ background: 'linear-gradient(135deg,#D4AF37,#F0C030)', border: 'none', borderRadius: 12, padding: '14px 28px', color: '#1E2B80', fontWeight: 900, fontSize: 15, cursor: 'pointer' }}>
          Intentar de nuevo
        </button>
