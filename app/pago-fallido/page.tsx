...
export default function PagoFallido() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(180deg,#FFFFFF,#F0F0F0)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 16, padding: 24 }}>
      ...
      <div style={{ display: 'flex', gap: 12, marginTop: 8, flexWrap: 'wrap', justifyContent: 'center' }}>
        <button onClick={() => router.push('/checkout')} style={{ background: 'linear-gradient(135deg,#FF6A3D,#FF8A63)', border: 'none', borderRadius: 12, padding: '14px 28px', color: '#FFFFFF', fontWeight: 900, fontSize: 15, cursor: 'pointer' }}>
          Intentar de nuevo
        </button>
