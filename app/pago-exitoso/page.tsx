...
export default function PagoExitoso() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F7F8FA', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 16, padding: 24 }}>
      ...
      <button onClick={() => router.push('/')} style={{ background: 'linear-gradient(135deg,#FF6A3D,#FF8A63)', border: 'none', borderRadius: 12, padding: '14px 32px', color: '#C01515', fontWeight: 900, fontSize: 15, cursor: 'pointer', marginTop: 8 }}>
        Volver al inicio
      </button>
    </div>
  )
