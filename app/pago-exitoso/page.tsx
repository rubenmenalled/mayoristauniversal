...
export default function PagoExitoso() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(180deg,#030D1E,#071633)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: 16, padding: 24 }}>
      ...
      <button onClick={() => router.push('/')} style={{ background: 'linear-gradient(135deg,#D4AF37,#F0C030)', border: 'none', borderRadius: 12, padding: '14px 32px', color: '#030D1E', fontWeight: 900, fontSize: 15, cursor: 'pointer', marginTop: 8 }}>
        Volver al inicio
      </button>
    </div>
  )
