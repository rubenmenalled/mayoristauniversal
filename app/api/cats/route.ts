...
const FOTOS: Record<string, string> = {
  ...
  'TODO X BULTO CERRADO': 'https://kdqijydsqukjvfjhgmkn.supabase.co/storage/v1/object/public/imagenes/categorias/todo-x-bulto-cerrado-banner.jpg',
