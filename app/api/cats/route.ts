...
const FOTOS: Record<string, string> = {
  ...
  'MATE Y REGIONALES':'https://images.unsplash.com/photo-1444157545135-c045be691b05?w=800&q=90',
...
export async function GET() {
  ...
  const SUBCATEGORIAS: Record<string, string[]> = {
    ...
    'CAZA PESCA CAMPING Y MAS': ['TACTICO', 'ACCESORIOS CAMPING'],
    ...
    'MATE Y REGIONALES':['Alimentos Regionales', 'Dulces y Conservas', 'Artesanías', 'Bebidas'],
