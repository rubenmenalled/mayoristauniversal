...
function PagoContent() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#C4956A', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
...
export default function PagoPage() {
  return (
    <Suspense fallback={<div style={{ minHeight: '100vh', background: '#C4956A' }} />}>
      <PagoContent />
    </Suspense>
  )
}
