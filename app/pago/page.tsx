...
function PagoContent() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#E8DCC8', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
...
export default function PagoPage() {
  return (
    <Suspense fallback={<div style={{ minHeight: '100vh', background: '#E8DCC8' }} />}>
      <PagoContent />
    </Suspense>
  )
}
