              ...
              {productosFiltrados.map((p, i) => (
                ...
                >
                  ...
                  <div style={{ padding: 8 }}>
                    ...
                    <button
                      style={{ width: '100%', marginTop: 10, padding: '7px', borderRadius: 8, border: 'none', cursor: 'pointer', background: 'linear-gradient(135deg,#D4AF37,#F0C030)', color: '#5C3A00', fontSize: 11, fontWeight: 900, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4, WebkitTapHighlightColor: 'transparent' }}
                      onClick={() => {
              ...
              {!zoom && <div style={{ flex: 1, overflow: 'auto', padding: isMobile ? '12px 14px 14px' : '18px 18px 18px', display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                ...
                <div style={{ display: 'flex', gap: 8, marginTop: 10 }}>
                  ...
                  <motion.button whileTap={{ scale: 0.97 }}
                    ...
                    style={{ flex: 2, background: 'linear-gradient(135deg,#D4AF37,#F0C030)', border: 'none', borderRadius: 10, padding: isMobile ? '14px 6px' : '10px 6px', color: '#5C3A00', fontWeight: 900, cursor: 'pointer', fontSize: isMobile ? 15 : 12, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
