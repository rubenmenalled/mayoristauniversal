...
export default function TerminosPage() {
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(180deg, #0A2147 0%, #1A3A6B 100%)', color: '#e8eaf0' }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 860, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 20 }}>
          ...
          <span style={{ color: '#fff', fontWeight: 900, fontSize: 20, letterSpacing: '0.04em' }}>
            MAYORISTA UNIVERSAL
          </span>
        </div>
      </div>
