...
export default function ComoComprarPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(180deg, #FFFFFF 0%, #F0F0F0 100%)' }}>
      ...
      {/* Header */}
      <div style={{
        background: 'rgba(240,240,240,0.97)', borderBottom: '1px solid rgba(255,106,61,0.2)',
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 16 }}>
          <button onClick={() => router.push('/')}
            style={{
              ...
              color: '#FF6A3D', fontWeight: 700, fontSize: 13,
            }}>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto', padding: '48px 24px' }}>
        ...
        <h1 style={{ color: '#FF6A3D', fontWeight: 900, fontSize: 28, marginBottom: 8, textAlign: 'center' }}>
