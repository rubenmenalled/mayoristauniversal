    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(180deg, #7B1450 0%, #8E1A5E 100%)' }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div style={{ color: '#FFFFFF', fontWeight: 900, fontSize: 20 }}>¿Cómo Comprar?</div>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto', padding: '48px 24px' }}>
        <motion.div
          ...
          <p style={{ color: '#e5e7eb', fontSize: 18, lineHeight: 1.7, marginBottom: 32 }}>
            ...
            <strong style={{ color: '#FFFFFF' }}>Añadir al carrito</strong>.
          </p>
        ...
        <motion.div
          ...
          <button onClick={() => router.push('/catalogo')}
            style={{
              ...
              color: '#7B1450', fontWeight: 900, fontSize: 15, cursor: 'pointer',
            }}>
            VER CATÁLOGO
          </button>
        </motion.div>
