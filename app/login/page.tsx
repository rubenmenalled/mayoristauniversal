...
export default function LoginPage() {
  ...
  return (
    <div style={{
      minHeight: '100vh', background: 'linear-gradient(180deg, #7B1450 0%, #8E1A5E 100%)',
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <a href="/" style={{ textDecoration: 'none' }}>
            <div style={{
              ...
              <ShoppingCart size={28} color="#7B1450" />
            </div>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <>
                ...
                <div style={{ marginBottom: 14 }}>
                  ...
                  <select value={transporte} onChange={e => setTransporte(e.target.value)} required
                    ...
                    <option value="" style={{ background: '#8E1A5E' }}>Seleccioná una opción</option>
                    {TRANSPORTES.map(t => (
                      <option key={t} value={t} style={{ background: '#8E1A5E' }}>{t}</option>
                    ))}
                  </select>
                </div>
            ...
            <button type="submit" disabled={loading}
              style={{
                ...
                background: 'linear-gradient(135deg,#D4AF37,#F0C030)', color: '#7B1450',
