...
const FOTOS: Record<string, string> = {
  ...
  'TODO PARA EL DEPORTE': 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=800&q=90',
...
function SkeletonGrid() {
  return (
    <section style={{ background: '#7A8C6A', padding: 'clamp(16px, 3vw, 32px) 16px' }}>
...
export default function CatalogosSection({ categorias }: { categorias?: Categoria[] }) {
  ...
  const PROXIMAMENTE = new Set(['BLANQUERIA', 'RODADOS'])

  return (
    <>
    <section id="catalogos" style={{ background: '#7A8C6A', padding: '4px 16px 16px' }}>
      <style dangerouslySetInnerHTML={{ __html: KEYFRAMES }} />
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        >
          <span style={{ color: '#7A8C6A', fontWeight: 900, fontSize: 'clamp(10px,2.5vw,13px)', letterSpacing: '0.04em', whiteSpace: 'nowrap' }}>
            IMPORTADOR DIRECTO
          </span>
