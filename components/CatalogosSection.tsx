...
function SkeletonGrid() {
  return (
    <section style={{ background: '#C4956A', padding: 'clamp(16px, 3vw, 32px) 16px' }}>
...
export default function CatalogosSection({ categorias }: { categorias?: Categoria[] }) {
  ...
  return (
    <>
    <section id="catalogos" style={{ background: '#C4956A', padding: '4px 16px 16px' }}>
      <style dangerouslySetInnerHTML={{ __html: KEYFRAMES }} />
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        >
          <span style={{ color: '#C4956A', fontWeight: 900, fontSize: 'clamp(10px,2.5vw,13px)', letterSpacing: '0.04em', whiteSpace: 'nowrap' }}>
            IMPORTADOR DIRECTO
          </span>
