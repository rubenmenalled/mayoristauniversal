          ...
          {unicas.map((cat, i) => {
            ...
            >
              ...
              <div style={{
                ...
                fontWeight: 900, fontSize: 12.5, padding: '6px 14px', borderRadius: 99,
                boxShadow: '0 3px 12px rgba(0,0,0,0.55)', zIndex: 9, whiteSpace: 'nowrap',
                border: '2px solid #FFFFFF', letterSpacing: '0.02em',
              }}>
