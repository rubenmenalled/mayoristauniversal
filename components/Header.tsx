    ...
    <header className={`fixed inset-x-0 z-50 transition-all duration-400 ${
      ...
      <div className="max-w-[1400px] mx-auto px-4 py-2.5">
        <div className="flex items-center gap-4">
          ...
          {/* Redes sociales — solo visibles en mobile, siempre en la barra */}
          <div className="lg:hidden flex items-center gap-1.5 ml-auto">
            {[
              ...
              <a key={s.name} href={s.href} target="_blank" rel="noopener noreferrer" title={s.name}
                style={{ width: 28, height: 28, borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', background: s.bg, border: `1px solid ${s.border}`, color: s.color, flexShrink: 0 }}>
                {s.icon}
              </a>
            ))}
          </div>
