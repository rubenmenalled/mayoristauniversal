export default function BannerMayorista() {
  ...
  const eyebrow: React.CSSProperties = {
    color: '#F5C518', fontWeight: 800, fontSize: 13,
  ...
  const gold: React.CSSProperties = { color: '#FFE45C' }
  ...
  const divider: React.CSSProperties = {
    ...
    background: 'linear-gradient(transparent, rgba(245,197,24,0.5), transparent)',
  }
