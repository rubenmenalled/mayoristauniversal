...
const social = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/stories/mayoristauniversal26/3905997769075229090?utm_source=ig_story_item_share', // ← cambiá esto
    icon: (
...
export default function Footer() {
  return (
    <footer id="contacto" className="relative overflow-hidden"
      style={{ background: 'linear-gradient(180deg, #0D1B2A 0%, #071018 100%)' }}>
      {/* Gold top border */}
