...
export default function Footer() {
  return (
    <footer id="contacto" className="relative overflow-hidden"
      ...
      <div className="absolute inset-0 w-full h-full bg-[#4B5563] z-10 [mask-image:radial-gradient(transparent,#4B5563)] pointer-events-none" />
              ...
              {social.map(s => (
                <motion.a
                  ...
                  style={{
                    ...
                    color: s.name === 'Instagram' ? '#FF0090' : s.name === 'Facebook' ? '#4B5563' : '#ffffff',
                  }}
