...
export default function PromoBanner() {
  ...
  return (
    <div className="relative overflow-hidden py-3 border-y border-gold/20"
      style={{ background: 'linear-gradient(135deg, #0A1D3D 0%, #6B543E 50%, #0A1D3D 100%)' }}>
      {/* Left & right fade masks */}
      <div className="absolute left-0 top-0 bottom-0 w-24 z-10 pointer-events-none"
        style={{ background: 'linear-gradient(to right, #6B543E, transparent)' }} />
      <div className="absolute right-0 top-0 bottom-0 w-24 z-10 pointer-events-none"
        style={{ background: 'linear-gradient(to left, #6B543E, transparent)' }} />
