    ...
    <div style={{ flex: '0 0 auto', width: 180, background: '#FFFFFF', border: '1px solid #E5E7EB', borderRadius: 14, overflow: 'hidden', display: 'flex', flexDirection: 'column', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
      ...
      <div style={{ padding: 10, display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        <button
          ...
          style={{ marginTop: 8, background: 'linear-gradient(135deg,#D4AF37,#F0C030)', border: 'none', borderRadius: 8, padding: '9px', color: '#5C3A00', fontWeight: 900, fontSize: 14, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
          🛒 Agregar
        </button>
      </div>
    </div>
